...
var DailyOptions = function DailyOptions(_ref) {
  ...
  return /*#__PURE__*/_react["default"].createElement("div", {
    className: _index["default"].WT_Calendar_DailyOptions
  }, /*#__PURE__*/_react["default"].createElement("div", {
    onClick: function onClick() {
      setTargetDay(new Date().getTime());
    },
    className: (0, _moment["default"])(targetDay).format('YYYY年MM月DD日') === (0, _moment["default"])(new Date()).format('YYYY年MM月DD日') ? _index["default"].WT_Calendar_DailyOptions_Btn : _index["default"].WT_Calendar_DailyOptions_Btn_unActive
  }, "\u4ECA\u5929"), /*#__PURE__*/_react["default"].createElement("div", {
    className: _index["default"].WT_Calendar_DailyOptions_DateShow
  }, /*#__PURE__*/_react["default"].createElement("div", {
    onClick: function onClick() {
      onChangeWeek('prevWeek');
    },
    className: _index["default"].WT_Calendar_DailyOptions_ChangeBtn
  }, "<"), /*#__PURE__*/_react["default"].createElement("div", {
    style: {
    ...
    className: _index["default"].WT_Calendar_DailyOptions_Checkout
  }, /*#__PURE__*/_react["default"].createElement("div", {
    onClick: function onClick() {
      setSwitchWeekendDay('day');
    },
    className: _index["default"].WT_Calendar_DailyOptions_Btn + " " + _index["default"].WT_Calendar_DailyOptions_DayBtn + " " + (switchWeekendDay === 'day' && _index["default"].WT_Calendar_DailyOptions_Active)
  }, "\u65E5"), /*#__PURE__*/_react["default"].createElement("div", {
    onClick: function onClick() {
      setCurrTime(targetDay);
      setSwitchWeekendDay('week');
    },
    className: _index["default"].WT_Calendar_DailyOptions_Btn + " " + _index["default"].WT_Calendar_DailyOptions_WeekBtn + " " + (switchWeekendDay === 'week' && _index["default"].WT_Calendar_DailyOptions_Active)
  }, "\u5468")));
};
